...
var templateManga = "<dt><div class='list-element'><div class='manga-title inline'>" +
    ...
    "<img class=\"manga-btn read-btn\" src=\"images/read.png\">" +
    "<div class=\"last-read\">last read: <label class=\"last-read-chapter\">%lastReadChapter%</label></div></div></dt>";
...
function appendElement(mangaElem) {
    ...
    mangaListElement = mangaListElement.replace("%lastReadChapter%", mangaElem.lastRead);
